...
async function main() {
    ...
    const USDT_Contract = await ethers.getContractAt("IERC20", USDC, impersonatedSigner);
    ...
    await ROUTER.addLiquidity(USDC, LSK, DESIRED_USD, DESIRED_LSK, MIN_USD, MIN_LSK, LIQUIDITY_RECEIVER, deadline); // ROUTER.addLiquidity
